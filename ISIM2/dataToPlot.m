function dataToPlot(simulations, plotType, plotPanel)
    arguments
        ...
        plotType               {mustBeMember(plotType,[ "Ic - Vce","hfe - Ic","Vcesat - Ic","Vbesat - Ic", ...
                                                        "Id - Vds","Rdson - Id","Id - Vgs","Rdson - Vgs"])}
        plotPanel   
    end
%     global app;
%     mustBeNonempty(app);
    ...
    if ismember(plotType,["Vcesat - Ic" "Vbesat - Ic"])
        dataToPlotVsatIc
    end
    if plotType == "Id - Vds"
        dataToPlotIdVds
    end
    if plotType == "Rdson - Id"
        dataToPlotRdsonId
    end
    if plotType == "Id - Vgs"
        dataToPlotIdVgs
    end
    if plotType == "Rdson - Vgs"
        dataToPlotRdsonVgs
    end
